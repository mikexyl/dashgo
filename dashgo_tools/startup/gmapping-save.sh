...
cp ~/dashgo_ws/src/dashgo/dashgo_nav/maps/$1.yaml ~/dashgo_ws/src/dashgo/dashgo_nav/maps/web_map.yaml

cp ~/dashgo_ws/src/dashgo/dashgo_nav/maps/$1.pgm ~/dashgo_ws/src/dashgo/dashgo_nav/maps/web_map.pgm
